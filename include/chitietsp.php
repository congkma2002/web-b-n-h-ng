...
function layChiTietSanPham($id)
{
    ...
    // Truy vấn cơ sở dữ liệu để lấy chi tiết sản phẩm với id tương ứng
...
function hienThiChiTietSanPham($sql_chitiet)
{
...
$sql_chitiet = layChiTietSanPham($id);
hienThiChiTietSanPham($sql_chitiet);
?>