...
function layDanhSachKhachHang($con)
{
    ...
    return $sql_select_khachhang;
}

function layChiTietGiaoDich($con,$magiaodich)
{
    // Truy vấn SQL để lấy chi tiết giao dịch theo mã giao dịch
...
$sql_select_khachhang = layDanhSachKhachHang($con);
$sql_select = layChiTietGiaoDich($con,$magiaodich);
?>
            ...
            <table class="table table-bordered ">
                ...
                while ($row_khachhang = mysqli_fetch_array($sql_select_khachhang)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?quanly=xemgiaodich&khachhang=<?php echo $row_khachhang['magiaodich'] ?>">Xem giao
                                dịch</a>
                        </td>
                    </tr>
                    <?php
