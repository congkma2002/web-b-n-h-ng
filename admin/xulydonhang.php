	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-5">
				...
				<?php
				$sql_select = mysqli_query($con, "SELECT * FROM tbl_sanpham, tbl_khachhang, tbl_donhang WHERE tbl_donhang.sanpham_id=tbl_sanpham.sanpham_id AND tbl_donhang.khachhang_id=tbl_khachhang.khachhang_id GROUP BY mahang ORDER BY tbl_donhang.tinhtrang ASC");
				?>
				<table class="table table-bordered ">
					<tr>
						<th>Thứ tự</th>
