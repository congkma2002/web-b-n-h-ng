...
function themBaiViet($con)
{
    if (isset($_POST['thembaiviet'])) {
        ...
        // Thêm bài viết vào bảng tbl_baiviet
...
function capNhatBaiViet($con)
{
    if (isset($_POST['capnhatbaiviet'])) {
        ...
        // Cập nhật thông tin bài viết trong bảng tbl_baiviet
